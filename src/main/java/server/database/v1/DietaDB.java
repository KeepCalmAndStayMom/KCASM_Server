...
public class DietaDB {
    ...
    public static List<Map<String,Object>> getDietaPrograms(int homestation_id){
        final String sql = "SELECT * FROM Dieta WHERE homestation_id=? AND inizio_programma=1";
