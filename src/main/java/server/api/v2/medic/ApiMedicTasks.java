...
public class ApiMedicTasks {
    ...
    private void singleTaskOperations(String taskCategory) {
        ...
        modifyTask(taskCategory);

        deleteTask(taskCategory);

        addTask(taskCategory);
    }

    private void addTask(String taskCategory) {
    ...
    private void deleteTask(String taskCategory) {
    ...
    private void modifyTask(String taskCategory) {
