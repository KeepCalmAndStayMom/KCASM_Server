...
public class SogliePeso {
    ...
    public final ArrayList<Float>  sott_gem_min, sott_gem_max, sott_min, sott_max,
                        norm_gem_min, norm_gem_max, norm_min, norm_max,
                        sov_gem_min, sov_gem_max, sov_min, sov_max,
                        ob_gem_min, ob_gem_max, ob_min, ob_max;

    public SogliePeso() {
        sott_gem_min = createList(SOTT_GEM_MIN);
    ...
    public ArrayList<Float> createList(int value) {
        int i;
        float j;
