...
public class RetrieveDataWeekPesoOut implements RetrieveDataInterface{
    ...
    private List<Double> list_min;
    private List<Double> list_max;
    ...
    public Object getData(int patientID, LocalDate actual_date, double actual_peso) {
        ...
        list_min = SogliePeso.getListSogliaMin(bmi, gemelli);
        list_max = SogliePeso.getListSogliaMax(bmi, gemelli);
